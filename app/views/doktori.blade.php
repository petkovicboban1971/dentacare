        ...
        <div class="container" data-scrollax-parent="true">
          <div class="row slider-text align-items-end">
            <div class="col-md-7 col-sm-12 ftco-animate mb-5">
              <p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="/index">{{ Langauge::lang(1, Session::get('jezik')) }}</a></span> <span>{{ Langauge::lang(4, Session::get('jezik')) }}</span></p>
              <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">{{ Langauge::lang(73, Session::get('jezik')) }}</h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				...
      				<div class="info text-center">
      					<h3><a href="teacher-single.html">Tomislav Malovčić</a></h3>
        	...
        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				...
      				<div class="info text-center">
      					<h3><a href="teacher-single.html">Marko Stojković</a></h3>
      					<span class="position">{{ Langauge::lang(24, Session::get('jezik')) }}</span>
      					<div class="text">
	        				<p>{{ Langauge::lang(52, Session::get('jezik')) }}</p>
	        				<ul class="ftco-social">
        	...
        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				...
      				<div class="info text-center">
      					<h3><a href="teacher-single.html">Pavle Stojković</a></h3>
      					<span class="position">{{ Langauge::lang(24, Session::get('jezik')) }}</span>
      					<div class="text">
	        				<p>{{ Langauge::lang(52, Session::get('jezik')) }}</p>
	        				<ul class="ftco-social">
        	...
        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				...
      				<div class="info text-center">
      					<h3><a href="teacher-single.html">Ivan Miljković</a></h3>
      					<span class="position">{{ Langauge::lang(81, Session::get('jezik')) }}</span>
      					<div class="text">
	        				<p>{{ Langauge::lang(52, Session::get('jezik')) }}</p>
	        				<ul class="ftco-social">
			              <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
        	...
        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				...
      				<div class="info text-center">
      					<h3><a href="teacher-single.html">Enver Mirašević</a></h3>
      					<span class="position">{{ Langauge::lang(24, Session::get('jezik')) }}</span>
      					<div class="text">
	        				<p>{{ Langauge::lang(52, Session::get('jezik')) }}</p>
	        				<ul class="ftco-social">
        	...
        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				...
      				<div class="info text-center">
      					<h3><a href="teacher-single.html">Dragutin Topić</a></h3>
      					<span class="position">{{ Langauge::lang(24, Session::get('jezik')) }}</span>
      					<div class="text">
	        				<p>{{ Langauge::lang(52, Session::get('jezik')) }}</p>
	        				<ul class="ftco-social">
        	...
        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				...
      				<div class="info text-center">
      					<h3><a href="teacher-single.html">Petar Grašo</a></h3>
      					<span class="position">{{ Langauge::lang(24, Session::get('jezik')) }}</span>
      					<div class="text">
	        				<p>{{ Langauge::lang(52, Session::get('jezik')) }}</p>
	        				<ul class="ftco-social">
        	...
        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				...
      				<div class="info text-center">
      					<h3><a href="teacher-single.html">Filip Višnjić</a></h3>
      					<span class="position">{{ Langauge::lang(81, Session::get('jezik')) }}</span>
      					<div class="text">
	        				<p>{{ Langauge::lang(52, Session::get('jezik')) }}</p>
	        				<ul class="ftco-social">
